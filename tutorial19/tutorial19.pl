...
sub RenderSceneCB {
    ...
    $self->pEffect->SetMatSpecularIntensity( 1 );
    $self->pEffect->SetMatSpecularPower( 32 );
...
sub main {
    ...
    if ( !GLUTBackendCreateWindow( WINDOW_WIDTH, WINDOW_HEIGHT, 0, "Tutorial 19" ) ) {
        return 1;
    }

    my $pApp = tutorial19->new;
